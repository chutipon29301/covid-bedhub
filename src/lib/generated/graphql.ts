...
export type GetJwtFromLineCodeMutation = (
  { __typename?: 'Mutation' }
  & { getJwtFromLineCode: (
    { __typename?: 'JwtTokenInfo' }
    & Pick<JwtTokenInfo, 'token' | 'expireDate'>
  ) }
);
...
export type MyPatientsQuery = (
  ...
  & { me: (
    ...
    & { patients: Array<(
      { __typename?: 'Patient' }
      & Pick<Patient, 'id' | 'reporterId' | 'firstName' | 'lastName' | 'birthDate' | 'sex' | 'identification' | 'tel'>
    )> }
  ) }
);
...
export type MyTicketSymptomsQuery = (
  { __typename?: 'Query' }
  & { myTicket?: Maybe<(
    { __typename?: 'Ticket' }
    & Pick<Ticket, 'status' | 'symptoms'>
    & { patient: (
      { __typename?: 'Patient' }
      & Pick<Patient, 'firstName' | 'lastName' | 'identification' | 'tel'>
    ) }
  )> }
);
...
export type MyTicketsQuery = (
  ...
  & { me: (
    ...
    & { tickets: Array<(
      { __typename?: 'Ticket' }
      & Pick<Ticket, 'id' | 'status' | 'appointedDate'>
      & { patient: (
        { __typename?: 'Patient' }
        & Pick<Patient, 'id' | 'firstName' | 'lastName' | 'identification'>
      ), hospital?: Maybe<(
        { __typename?: 'Hospital' }
...
export type PatientQuery = (
  ...
  & { patient: (
    { __typename?: 'Patient' }
    & Pick<Patient, 'firstName' | 'lastName' | 'birthDate' | 'sex' | 'identification' | 'tel' | 'illnesses'>
  ) }
);
...
export const CancelTicket = (
            options: Omit<
              MutationOptions<any, CancelTicketMutationVariables>, 
              "mutation"
            >
          ) => {
...
export const CreatePatient = (
            options: Omit<
              MutationOptions<any, CreatePatientMutationVariables>, 
              "mutation"
            >
          ) => {
...
export const CreateTicket = (
            options: Omit<
              MutationOptions<any, CreateTicketMutationVariables>, 
              "mutation"
            >
          ) => {
...
export const GetJwtFromLineCode = (
            options: Omit<
              MutationOptions<any, GetJwtFromLineCodeMutationVariables>, 
              "mutation"
            >
          ) => {
...
export const UpdatePatient = (
            options: Omit<
              MutationOptions<any, UpdatePatientMutationVariables>, 
              "mutation"
            >
          ) => {
...
export const MyPatients = (
            options: Omit<
              WatchQueryOptions<MyPatientsQueryVariables>, 
              "query"
            >
          ): Readable<
...
export const MyTicketSymptoms = (
            options: Omit<
              WatchQueryOptions<MyTicketSymptomsQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<MyTicketSymptomsQuery> & {
              query: ObservableQuery<
                MyTicketSymptomsQuery,
                MyTicketSymptomsQueryVariables
              >;
            }
          > => {
            const q = client.watchQuery({
...
export const MyTickets = (
            options: Omit<
              WatchQueryOptions<MyTicketsQueryVariables>, 
              "query"
            >
          ): Readable<
...
export const Patient = (
            options: Omit<
              WatchQueryOptions<PatientQueryVariables>, 
              "query"
            >
          ): Readable<
